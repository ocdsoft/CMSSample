...
namespace Benefits.Shared.Infrastructure
{
    ...
    public static class Evaluator
    {
        ...
        class SubtreeEvaluator : ExpressionVisitor
        {
            ...
            /// <summary>
            /// Overrides built-in VisitMemberInit if Linq.Expression type is a new type.
            /// This allows the linq cache expressions to work when new type is returned via Select
            /// Ex: .Select( c => new SomeObject { PropertyName = c.PropertyName }) 
            /// </summary>
